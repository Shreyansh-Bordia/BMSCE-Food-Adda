...
import com.example.bmscefoodadda.databinding.NotifcatioitemBinding
...
class notificationAdapter(private var notification: ArrayList<String>, private var notificationImage:ArrayList<Int> ) :RecyclerView.Adapter<notificationAdapter.NotificationViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NotificationViewHolder {
        val binding = NotifcatioitemBinding.inflate(LayoutInflater.from(parent.context),parent,false)
    ...
    inner class NotificationViewHolder(private val binding: NotifcatioitemBinding) :RecyclerView.ViewHolder(binding.root)  {
